  ...
  <div class="pt-8 pl-6 pr-3 md:px-0 pb-4 md:container md:m-auto md:pt-16 md:flex">
    <div class="md:basis-1/2 md:flex md:flex-col h-full">
      ...
      <div class="flex items-center justify-between md:justify-normal md:gap-10">
        <h5
          class="font-jost uppercase text-[13px] font-[600] tracking-widest text-[#DD5903] w-fit md:text-lg"
          id="p"
        >
          {{ smallText }}
        </h5>
      ...
      <div class="">
        <!-- paragraph -->
        <p
          class="font-jost text-[18px] leading-relaxed tracking-wide text-[#4a4a4b] 2xl:w-3/4 2xl:pb-7"
        >
          {{ paragraph }}
        </p>
