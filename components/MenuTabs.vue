<template>
  <div>
    ...
    >
      ...
      <option disabled value="0">Select a Menu</option>
    ...
    <div class="hidden sm:block">
      <div class="tab-buttons flex gap-2">
        <button
          ...
          class="py-2 px-4 text-lg text-[#DD5903] uppercase"
        >
          {{ tab.name }}
        </button>
      </div>
        ...
        <div class="tab-content flex basis-1/3 flex-wrap justify-between gap-x-4">
          ...
          >
            ...
            <div class="absolute inset-0 flex items-center justify-center text-white">
              <h2
                class="text-4xl text-center md:text-3xl lg:text-4xl uppercase w-9/12 xl:text-6xl"
              >
                {{ `${menuName} Menu` }}
              </h2>
            </div>
