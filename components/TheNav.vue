    ...
    <div class="hidden md:block absolute h-fit inset-0 z-50 container mx-auto text-white">
      ...
      >
        ...
        >
          ...
          <!-- text  -->
          <a class="text-sm text-gray-400" href=""> Banda Street, Nairobi , Kenya </a>
        </div>
        <!-- phone  -->
        <div
        ...
        >
          ...
          <!-- text  -->
          <a class="text-sm text-gray-400" href="tel:0745015869"> +254 745 015 869 </a>
        </div>
        <!-- email  -->
        <div
          class="py-2 border-r border-gray-500 rounded-sm px-5 grow flex justify-center items-center w-fit gap-3"
      ...
      <div class="flex items-center py-5">
        ...
        <div class="flex-grow flex justify-end items-center gap-5">
          <!-- nav items -->
          <div class="flex-grow flex justify-end items-center gap-5">
            <NuxtLink to="/" class="text-lg border-button font-Lexend"> Home </NuxtLink>
          ...
          <div class="flex justify-end items-center gap-5">
            <NuxtLink to="/contactus" class="text-lg font-Lexend hover:">
